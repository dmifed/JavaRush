...
public class Solution {
    ...
    public static boolean isAllModifiersContainSpecificModifier(int allModifiers, int specificModifier) {
        //String allMod = String.format("%8s%n", Integer.toBinaryString(allModifiers)).replace(' ', '0');
        //String specificMod = String.format("%8s%n", Integer.toBinaryString(specificModifier)).replace(' ', '0');
        //System.out.println(allMod + specificMod);
